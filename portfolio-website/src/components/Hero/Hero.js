...
export const Hero = () => {
  return (
    <div className="px-5 gap-y-4 pt-[18%] w-full flex flex-col items-center lg:pt-0 lg:px-0 lg:flex-row lg:items-end lg:w-[960px] lg:mx-auto">
      ...
      <a href="https://github.com/Mferik" target="_blank" className="py-3 px-3 flex items-center gap-x-[10px] bg-white text-[#3730A3] rounded-md cursor-pointer hover:bg-opacity-90">
        <SiGithub size={30} />
      ...
      <a
        ...
        target="_blank"
        className="py-3 px-3 flex items-center gap-x-[10px] bg-white text-[#3730A3] rounded-md cursor-pointer hover:bg-opacity-90"
      >
        <SiLinkedin  size={30}/>
