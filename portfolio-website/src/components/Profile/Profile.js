    ...
    >
      <div className="px-5 pt-16 pb-16 flex flex-col gap-y-5 lg:p-0 lg:w-[960px] lg:mx-auto lg:gap-8">
        {language !== "tr" ? (
          ...
          <h2 className="text-[48px] text-[#CBF281] font-bold">Profil</h2>
        )}
              ...
              <div className="h-[222px] flex flex-col justify-between text-[15px]  leading-[1.5]">
                ...
                <div className="flex justify-between">
                  ...
                  <p className="w-[190px] text-white">
                    Yildiz Technical Uni. - Metallurgical and Materials
                    Engineering, 2022
                  </p>
                </div>
                <div className="flex justify-between">
          ...
          {language !== "tr" ? (
            <div className="flex flex-col gap-y-6  w-[300px] m-auto">
              ...
              <div className="h-[240px] text-center flex flex-col justify-between text-white text-[18px] leading-[1.5] lg:text-left">
                <p>
                  I am Fatih, I am on my way to becoming a Full Stack Web
                  Developer with the Workintech family.
                </p>

                <p>
                  You can have a pleasant time on my web page, you can review my
            ...
            <div className="flex flex-col gap-y-6  w-[300px] m-auto">
              ...
              <div className="h-[240px] text-center flex flex-col justify-between text-white text-[18px] leading-[1.5] lg:text-left">
                <p>
                  Ben Fatih, Workintech ailesi ile Full Stack Web Developer olma
                  yolunda ilerliyorum.
                </p>

                <p>
                  Web sayfamda keyifli vakit geçirebilir, projelerimi
