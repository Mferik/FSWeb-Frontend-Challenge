...
export const Header = () => {
  ...
  return (
    ...
    >
      ...
      <button className="" onClick={handleLanguage}>
        {language !== "tr" ? (
          <p className=" tr text-[#CAF181] dark:text-[#BAB2E7]">
            TÜRKÇE'
            <span className="dark:text-[#777777] text-[#D9D9D9]">YE GEÇ</span>
          </p>
        ) : (
          <p className=" tr text-[#CAF181] dark:text-[#BAB2E7]">
            FOR
            <span className="dark:text-[#777777] text-[#D9D9D9]"> ENGLISH</span>
          </p>
        )}
      </button>
