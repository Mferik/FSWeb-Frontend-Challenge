    ...
    >
      <div className="px-5 pt-16 pb-16 flex flex-col items-center text-center gap-y-6 lg:p-0 lg:w-[500px] lg:mx-auto">
        ...
        {language !== "tr" ? (
          ...
          <p className="text-[24px] text-[#120B39] leading-normal dark:text-[#FFFFFF]">
            Bir sorunuz ya da öneriniz mi var, yoksa sadece merhaba mı demek
        ...
        <div className="flex flex-col gap-y-4">
          <a
            ...
            className="text-[20px] text-[#4731D3] font-medium underline cursor-pointer hover:text-[#0a0558] hover:no-underline dark:text-[#8F88FF] dark:hover:text-[#bbbbbbec]"
          >
        ...
        <div className="flex gap-x-6 text-[#4731D3]  dark:text-[#8F88FF] ">
          <a href="https://twitter.com/_mfedev" target="_blank">
            <FiTwitter
              className="cursor-pointer hover:text-[#0a0558] dark:hover:text-[#bbbbbbec]"
              size={35}
            />
          </a>
